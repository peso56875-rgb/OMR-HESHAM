...
console.log('\n  استنتاج المورد والمعرّف من المسار:')
{
  const cases = [
    ...
    // انحدار حقيقي: مسارات المشروع على نمط /add و /edit/:id، فأول نسخة
    // من القائمة (أفعال REST عامة) سجّلت "add" كأنها معرّف سجل في أول
    // عملية حقيقية اتعملت على Firestore.
    ['/api/campaigns/add', 'campaigns', null],
    ['/api/campaigns/edit/xYz123', 'campaigns', 'xYz123'],
    ['/api/campaigns/delete/xYz123', 'campaigns', 'xYz123'],
    ['/api/treasury/income', 'treasury', null],
    ['/api/treasury/expense', 'treasury', null],
    ['/api/users/role', 'users', null],
    ['/api/contact/clear-all', 'contact', null],
    ['/api/volunteers/update-hours', 'volunteers', null],
    ['/api/cases/groups', 'cases', null],
  ]
